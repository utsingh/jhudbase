...
LOAD DATA LOCAL INFILE './small/Countries-small.txt' INTO TABLE Countries
...
LOAD DATA LOCAL INFILE './small/regions-small.txt' INTO TABLE Region
   FIELDS TERMINATED BY ',';  
...
LOAD DATA LOCAL INFILE './small/democracies-small.txt' INTO TABLE Democracies
   FIELDS TERMINATED BY ',';  
...
LOAD DATA LOCAL INFILE './small/population-small.txt' INTO TABLE Population
   FIELDS TERMINATED BY ',';  
...
LOAD DATA LOCAL INFILE './small/Life_Expectancy-small.txt' INTO TABLE Life_Expectancy
   FIELDS TERMINATED BY ',';  
...
LOAD DATA LOCAL INFILE './small/Malaria-small.txt' INTO TABLE Malaria
   FIELDS TERMINATED BY ',';  
...
LOAD DATA LOCAL INFILE './small/covid19_confirmed_global-small.txt' INTO TABLE covid19_confirmed_global
   FIELDS TERMINATED BY ',';  
...
LOAD DATA LOCAL INFILE './small/covid19_deaths_global-small.txt' INTO TABLE covid19_deaths_global
   FIELDS TERMINATED BY ',';  
...
LOAD DATA LOCAL INFILE './small/covid19_recovered_global-small.txt' INTO TABLE covid19_recovered_global
   FIELDS TERMINATED BY ',';  
