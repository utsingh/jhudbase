...
window.onload = function () { 
	var chart = new CanvasJS.Chart("chartContainer", {
		...
		title:{
			text: "Weighted average democracy index data for each hemisphere"
		},
		axisX:{
			interval: 1
		},
