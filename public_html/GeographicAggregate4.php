...
window.onload = function () { 
	var chart = new CanvasJS.Chart("chartContainer", {
		...
		title:{
			text: "Weighted average democracy index data of each region"
		},
		axisX:{
			interval: 1
		},
